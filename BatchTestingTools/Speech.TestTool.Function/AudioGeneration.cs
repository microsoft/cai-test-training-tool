...
//{
//    public static class AudioGeneration
//    {


//        [FunctionName("AudioGeneration")]
//        public async static void Run([QueueTrigger("audiogenerationtasks", Connection = "")]AudioGenerationTask myQueueItem, TraceWriter log)
//        {
//            try
//            {

//                await AudioGenerationJobStorageHelper.UpdateBatchJobStatus(myQueueItem.JobId, "Queuing Job to Speech Service", null, "6%");
...
//                List<string> transcriptValues = GetTranscriptValues(container, myQueueItem.JobId, myQueueItem.TranscriptFileName);
...
//        private static List<string> GetTranscriptValues(CloudBlobContainer container, string JobId, string transcriptFileName)
//        {
...
//            List<string> transcriptionInputs = new List<string>();
...
//                    {
//                        transcriptionInputs.Add(line);
//                    }
//                }
//            }

//            return transcriptionInputs;
//        }
//    }
